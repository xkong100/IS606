...
```
the correlation coefficient is 0.610 which is close to 1. It is relatively positive relationship. We can trust the result.
...
-   How does this relationship compare to the relationship between `runs` and 
    ...
    tell?
    The at bats is a better predictor of runs than the strikeout since R^2 for the strikeouts is 0.1694 that is lower than the R^2 for at_bats. 
